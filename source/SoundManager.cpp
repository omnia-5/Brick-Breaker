...
sf::SoundBuffer generateBuffer(std::string filename) {
	...
	buffer.loadFromFile("C:/Users/DELL/Desktop/BrickBreaker/BrickBreaker/sounds/loaders" + filename);
	return buffer;
}

// Constructor
SoundManager::SoundManager(std::string musicFileName, std::string sfxFileName) {
	std::ifstream musicFile("C:/Users/DELL/Desktop/BrickBreaker/BrickBreaker/sounds/loaders" + musicFileName + ".txt");
	...
	musicFile.close();
	std::ifstream sfxFile("C:/Users/DELL/Desktop/BrickBreaker/BrickBreaker/sounds/loaders" + sfxFileName + ".txt");
	if (sfxFile.is_open()) {
		std::string line, name, source;
...
void SoundManager::playMusic(std::string name) {
	playingNow = name;
	music.openFromFile("C:/Users/DELL/Desktop/BrickBreaker/BrickBreaker/sounds/music" + musicBuffers[name]);
	music.play();
};

void SoundManager::pause() {
	music.openFromFile("C:/Users/DELL/Desktop/BrickBreaker/BrickBreaker/sounds/music" + musicBuffers[playingNow]);
	music.pause();
};
